...
import static com.nvr.video.constant.NvrSdkConstant.HCNETSDK_PATH;
import static com.nvr.video.constant.NvrSdkConstant.PLAYCTRL_PATH;
...
public interface HCNetSDK extends Library {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(HCNETSDK_PATH,
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
{
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(PLAYCTRL_PATH,
            PlayCtrl.class);
